...
/* =========================== BLOC FILES CREATE ========================================*/
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/bloc_scope.txt'),
  );

  createFile(
    'lib/core/bloc/bloc_observer.dart',
    content: await readContentFromFile('assets/bloc_observer.txt'),
  );
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/constants.txt'),
  );
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/local_config.txt'),
  );

  createFile(
    'lib/core/config/network_config.dart',
    content: await readContentFromFile('assets/network_config.txt'),
  );
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/app_router.txt'),
  );

  createFile(
    'lib/core/routes/navigation_observer.dart',
    content: await readContentFromFile('assets/navigation_observer.txt'),
  );
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/di.txt'),
  );
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/exeptions.txt'),
  );

  createFile(
    'lib/core/errors/failure.dart',
    content: await readContentFromFile('assets/failure.txt'),
  );
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/extension.txt'),
  );
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/enums.txt'),
  );
...
/* =========================== USECASE FILE CREATE ========================================*/
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/usecase.txt'),
  );
...
/* ============================= UTILS FILE CREATE ========================================*/
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/validator.txt'),
  );
  createFile(
    'lib/core/utils/formatters.dart',
    content: await readContentFromFile('assets/formatters.txt'),
  );
...
/* ============================= THEMES FILE CREATE ========================================*/
  ...
  createFile(
    ...
    content: await readContentFromFile('assets/app_diemens.txt'),
  );

  createFile(
    'lib/core/themes/app_colors.dart',
    content: await readContentFromFile('assets/app_colors.txt'),
  );
  createFile(
    'lib/core/themes/app_fonts.dart',
    content: await readContentFromFile('assets/app_fonts.txt'),
  );

  createFile(
    'lib/core/themes/app_theme.dart',
    content: await readContentFromFile('assets/app_theme.txt'),
  );
}
